class MarvelService {
    ...
    _apiKay = 'apikey=282348cdb8d673501fb4f4f5b14edcd0';
    _baseOffset = 210;
    ...
    _transformCharacter = (char) => {
        return {
            id: char.id,
            name: char.name,
            description: char.description.length > 180 ? `${char.description.substring(0, 180)}...` : char.description || 'нет данных об этом персонаже',
